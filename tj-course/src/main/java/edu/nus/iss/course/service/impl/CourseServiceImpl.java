...
import edu.nus.iss.api.dto.course.*;
import edu.nus.iss.api.dto.leanring.LearningLessonDTO;
import edu.nus.iss.api.dto.leanring.LearningRecordDTO;
...
import edu.nus.iss.course.constants.RedisContants;
import edu.nus.iss.course.domain.dto.CoursePageQuery;
import edu.nus.iss.course.domain.dto.CourseSimpleInfoListDTO;
import edu.nus.iss.course.domain.po.Category;
import edu.nus.iss.course.domain.po.Category3PO;
import edu.nus.iss.course.domain.po.Course;
import edu.nus.iss.course.domain.po.CourseTeacher;
import edu.nus.iss.course.domain.vo.*;
import edu.nus.iss.course.mapper.CourseDraftMapper;
import edu.nus.iss.course.mapper.CourseMapper;
import edu.nus.iss.course.mapper.CourseTeacherMapper;
import edu.nus.iss.course.service.*;
