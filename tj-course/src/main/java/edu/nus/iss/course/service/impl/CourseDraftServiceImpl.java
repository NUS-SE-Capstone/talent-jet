...
import edu.nus.iss.api.dto.course.CourseDTO;
...
import edu.nus.iss.course.domain.dto.CourseBaseInfoSaveDTO;
import edu.nus.iss.course.domain.dto.CoursePageQuery;
import edu.nus.iss.course.domain.po.*;
import edu.nus.iss.course.domain.vo.CourseBaseInfoVO;
import edu.nus.iss.course.domain.vo.CoursePageVO;
import edu.nus.iss.course.domain.vo.CourseSaveVO;
import edu.nus.iss.course.domain.vo.NameExistVO;
import edu.nus.iss.course.mapper.*;
