package edu.nus.iss.gateway.filter;
...
import edu.nus.iss.gateway.config.AuthProperties;
...
import static edu.nus.iss.auth.common.constants.JwtConstants.AUTHORIZATION_HEADER;
import static edu.nus.iss.auth.common.constants.JwtConstants.USER_HEADER;
