package edu.nus.iss.authsdk.gateway.util;
...
import edu.nus.iss.auth.common.domain.PrivilegeRoleDTO;
import edu.nus.iss.common.domain.R;
import edu.nus.iss.common.domain.dto.LoginUserDTO;
import edu.nus.iss.common.exceptions.ForbiddenException;
import edu.nus.iss.common.exceptions.UnauthorizedException;
...
import static edu.nus.iss.auth.common.constants.AuthErrorInfo.Code.EXPIRED_TOKEN_CODE;
import static edu.nus.iss.auth.common.constants.AuthErrorInfo.Code.INVALID_TOKEN_CODE;
import static edu.nus.iss.auth.common.constants.AuthErrorInfo.Msg.*;
import static edu.nus.iss.auth.common.constants.JwtConstants.*;
