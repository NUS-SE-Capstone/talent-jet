...
import edu.nus.iss.auth.domain.po.Privilege;
import edu.nus.iss.auth.domain.po.RolePrivilege;
import edu.nus.iss.auth.mapper.PrivilegeMapper;
import edu.nus.iss.auth.service.IPrivilegeService;
...
import static edu.nus.iss.auth.constants.AuthConstants.ADMIN_ROLE_ID;
